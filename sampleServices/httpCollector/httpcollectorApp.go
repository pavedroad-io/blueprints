...
func (a *HttpCollectorApp) Initialize() {
...
func (a *HttpCollectorApp) Run(addr string) {
...
func (a *HttpCollectorApp) initializeEnvironment() {
	var envVar = ""
...
func (a *HttpCollectorApp) initializeRoutes() {

	uri := HttpCollectorAPIVersion + "/" +
				HttpCollectorNamespaceID + "/" +
				HttpCollectorDefaultNamespace + "/" +
				HttpCollectorResourceType + "/" +
				HttpCollectorJobsEndPoint + "LIST"
	...
	uri = HttpCollectorAPIVersion + "/" +
				...
				HttpCollectorDefaultNamespace + "/" +
				HttpCollectorResourceType + "/" +
				HttpCollectorSchedulerEndPoint + "LIST"
	...
	uri = HttpCollectorAPIVersion + "/" +
				...
				HttpCollectorDefaultNamespace + "/" +
				HttpCollectorResourceType + "/" +
				HttpCollectorJobsEndPoint + HttpCollectorKey
...
// listJobs swagger:route GET /api/v1/namespace/mirantis/httpcollector/HttpCollectorJobsEndPointLIST jobs listjobs
//
...
func (a *HttpCollectorApp) listJobs(w http.ResponseWriter, r *http.Request) {
...
// listSchedule swagger:route GET /api/v1/namespace/mirantis/httpcollector/HttpCollectorSchedulerEndPointLIST schedules listschedule
//
...
func (a *HttpCollectorApp) listSchedule(w http.ResponseWriter, r *http.Request) {
	respondWithJSON(w, http.StatusOK, "{}")
}


// getJob swagger:route GET /api/v1/namespace/mirantis/httpcollector/jobs/{key} job getjob
//
...
//				404: get404Response
//				500: genericError
func (a *HttpCollectorApp) getJob(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	key := vars["key"]
...
// getSchedule swagger:route GET /api/v1/namespace/mirantis/httpcollector/schedule/{key} schedule getschedule
//
...
//		200: genericResponse
//		500: genericError
func (a *HttpCollectorApp) getSchedule(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	key := vars["key"]
...
// getLiveness swagger:route GET /api/v1/namespace/mirantis/httpcollector/liveness liveness getliveness
//
...
//				200: genericResponse
//				503: genericError
func (a *HttpCollectorApp) getLiveness(w http.ResponseWriter, r *http.Request) {
...
// getReadiness swagger:route GET /api/v1/namespace/mirantis/httpcollector/ready ready getready
//
...
func (a *HttpCollectorApp) getReadiness(w http.ResponseWriter, r *http.Request) {
...
// getMetrics swagger:route GET /api/v1/namespace/mirantis/httpcollector/metrics metrics getMetrics
//
// Returns metrics for httpcollector service
...
func (a *HttpCollectorApp) getMetrics(w http.ResponseWriter, r *http.Request) {
...
// getManagement swagger:route GET /api/v1/namespace/mirantis/httpcollector/management management getmanagement
//
...
func (a *HttpCollectorApp) getManagement(w http.ResponseWriter, r *http.Request) {
	// Pre-processing hook
...
// putmanagement swagger:route GET /api/v1/namespace/mirantis/httpcollector/management management putmanagement
//
// Returns available management commands
//
// Responses:
...
//				400: genericError
//				500: genericError
func (a *HttpCollectorApp) putManagement(w http.ResponseWriter, r *http.Request) {
...
// createJob swagger:route POST /api/v1/namespace/mirantis/httpcollector/HttpCollectorJobsEndPoint HttpCollectorJobsEndPoint createJob
//
// Create a new Job
//
// Responses:
...
//				201: listJobResponse
//				400: genericError
func (a *HttpCollectorApp) createJob(w http.ResponseWriter, r *http.Request) {
...
// updateJob swagger:route PUT /api/v1/namespace/mirantis/httpcollector/HttpCollectorJobsEndPoint/{key} HttpCollectorSchedulerEndPoint updateJob
//
// Update a HttpCollectorJobsEndPoint specified by key, where key is a uuid
//
// Responses:
//		default: genericError
//				200: listJobResponse
//				400: genericError
//				404: genericError
func (a *HttpCollectorApp) updateJob(w http.ResponseWriter, r *http.Request) {
	// Read URI variables
	vars := mux.Vars(r)
	key := vars["key"]
...
// deleteJob swagger:route DELETE /api/v1/namespace/mirantis/httpcollector/HttpCollectorJobsEndPoint/{key} HttpCollectorJobsEndPoint deleteJobs
//
...
//				200: listJobResponse
//				400: genericError
func (a *HttpCollectorApp) deleteJob(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	key := vars["key"]
...
// createSchedule swagger:route POST /api/v1/namespace/mirantis/httpcollector/HttpCollectorSchedulerEndPoint HttpCollectorSchedulerEndPoint createSchedule
//
...
//				201: genericResponse
//				400: genericError
func (a *HttpCollectorApp) createSchedule(w http.ResponseWriter, r *http.Request) {
...
// updateSchedle swagger:route PUT /api/v1/namespace/mirantis/httpcollector/HttpCollectorSchedulerEndPoint/{key} HttpCollectorSchedulerEndPoint updateSchedule
//
// Update a HttpCollectorSchedulerEndPoint specified by key, where key is a uuid
//
// Responses:
//		default: genericError
//				200: genericResponse
//				400: genericError
func (a *HttpCollectorApp) updateSchedule(w http.ResponseWriter, r *http.Request) {
	// Read URI variables
	vars := mux.Vars(r)
	key := vars["key"]
...
// deleteSchedule swagger:route DELETE /api/v1/namespace/mirantis/httpcollector/HttpCollectorSchedulerEndPoint/{key} HttpCollectorSchedulerEndPoint deleteSchudler
//
// Delete a job specified by key, which is a uuid
//
// Responses:
...
//				200: genericResponse
//				400: genericError
func (a *HttpCollectorApp) deleteSchedule(w http.ResponseWriter, r *http.Request) {
	// Read URI variables
	vars := mux.Vars(r)
	key := vars["key"]
